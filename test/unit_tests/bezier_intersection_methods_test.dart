...
void main() {
  group('intersectionsWithCurve', () {
    test('quadratic intersectionsWithCurve', () {
      final curveA = QuadraticBezier([Vector2(0.0, 0.0), Vector2(50.0, 50.0), Vector2(100.0, 0.0)]);

      final curveB =
          QuadraticBezier([Vector2(0.0, 50.0), Vector2(50.0, -100.0), Vector2(100.0, 50.0)]);
    ...
    test('cubic intersectionsWithCurve', () {
      final curveA = CubicBezier(
          [Vector2(0.0, 0.0), Vector2(0.0, 50.0), Vector2(100.0, 50.0), Vector2(100.0, 0.0)]);

      final curveB = CubicBezier(
          [Vector2(-10.0, 15.0), Vector2(10.0, 25.0), Vector2(90.0, 25.0), Vector2(110.0, 15.0)]);
    ...
    test('cubic intersectionsWithCurve with quadratic curve', () {
      ...
      final curveB =
          QuadraticBezier([Vector2(-10.0, 15.0), Vector2(50.0, 25.0), Vector2(110.0, 15.0)]);
    ...
    test('quadratic intersectionsWithCurve, one intersection', () {
      ...
      final curveB =
          QuadraticBezier([Vector2(50.0, 0.0), Vector2(150.0, 300.0), Vector2(250.0, 0.0)]);
    ...
    test('quadratic intersectionsWithCurve, two intersections', () {
      ...
      final curveB =
          QuadraticBezier([Vector2(25.0, 100.0), Vector2(75.0, -100.0), Vector2(125.0, 100.0)]);
    ...
    test('quadratic intersectionsWithCurve, four intersections', () {
      final curveA =
          QuadraticBezier([Vector2(0.0, 0.0), Vector2(50.0, 200.0), Vector2(100.0, 0.0)]);

      final curveB =
          QuadraticBezier([Vector2(-50.0, 0.0), Vector2(250.0, 50.0), Vector2(-50.0, 100.0)]);
    ...
    test('cubic intersectionsWithCurve, five intersections', () {
      final curveA = CubicBezier(
          [Vector2(0.0, 0.0), Vector2(50.0, 300.0), Vector2(50.0, -200.0), Vector2(100.0, 100.0)]);
    ...
    test('cubic intersectionsWithCurve(), nine intersections', () {
      ...
      final curveB = CubicBezier(
          [Vector2(0.0, 80.0), Vector2(350.0, 50.0), Vector2(-300.0, 50.0), Vector2(100.0, 20.0)]);
    ...
    test(
        ...
        () {
      final curveA =
          QuadraticBezier([Vector2(0.0, 0.0), Vector2(50.0, 20.0), Vector2(100.0, 100.0)]);

      final curveB =
          QuadraticBezier([Vector2(0.0, 10.0), Vector2(50.0, 25.0), Vector2(100.0, 90.0)]);
  ...
  group('intersectionsWithSelf', () {
    ...
    test(
        ...
        () {
      final curve = CubicBezier(
          [Vector2(10.0, 0.0), Vector2(180.0, 200.0), Vector2(200.0, 180.0), Vector2(0.0, 10.0)]);
  ...
  group('intersectionsWithLineSegment', () {
    ...
    test('quadratic intersectionsWithLineSegment, diagonal line with two intersections', () {
      final points = [Vector2(10.0, 500.0), Vector2(50.0, 0.0), Vector2(90.0, 500.0)];
    ...
    test(
        ...
        () {
      final curve =
          QuadraticBezier([Vector2(0.0, 0.0), Vector2(100.0, 0.0), Vector2(100.0, 100.0)]);
      final p1 = Vector2(0.0, 50.0);
      final p2 = Vector2(100.0, 50.0);
    ...
    test('cubic intersectionsWithLineSegment, horizontal line, two intersections', () {
      final curve = CubicBezier(
          [Vector2(0.0, 0.0), Vector2(20.0, 100.0), Vector2(80.0, 200.0), Vector2(100.0, 0.0)]);
      final p1 = Vector2(0.0, 20.0);
      final p2 = Vector2(100.0, 20.0);
    ...
    test('cubic intersectionsWithLineSegment, horizontal line, three intersections', () {
      final curve = CubicBezier(
          [Vector2(0.0, 0.0), Vector2(50.0, 200.0), Vector2(50.0, -100.0), Vector2(100.0, 100.0)]);
      final p1 = Vector2(0.0, 50.0);
      final p2 = Vector2(100.0, 50.0);
    ...
    test('cubic intersectionsWithLineSegment, vertical line with looped curve, three intersection',
        () {
      final curve = CubicBezier(
          [Vector2(0.0, 0.0), Vector2(200.0, 100.0), Vector2(-100.0, 100.0), Vector2(100.0, 0.0)]);
    ...
    test(
        ...
        () {
      final curve = CubicBezier(
          [Vector2(0.0, 0.0), Vector2(20.0, 20.0), Vector2(50.0, 50.0), Vector2(100.0, 100.0)]);
      final p1 = Vector2(100.0, 0.0);
    ...
    test('cubic intersectionsWithLineSegment, y axis through typical curve, one intersection', () {
      final curve = CubicBezier([
        Vector2(-214.5, 80.0),
        Vector2(-52.0, 80.0),
        Vector2(52.0, 530.0),
    ...
    test('cubic intersectionsWithLineSegment, horizontal line through typical curve', () {
      final curve = CubicBezier([
        Vector2(214.5, 630.0),
    ...
    test('cubic intersectionsWithLineSegment, horizontal line through typical curve, translated up',
        () {
      final offset = 6.0;
      final curve = CubicBezier([
