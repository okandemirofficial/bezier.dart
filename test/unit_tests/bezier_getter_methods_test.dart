...
void main() {
  group('startPoint', () {
    ...
    test('cubic startPoint', () {
      final curve = CubicBezier(
          [Vector2(90.0, 80.0), Vector2(50.0, 10.0), Vector2(40.0, 85.0), Vector2(95.0, 30.0)]);
  ...
  group('isClockwise', () {
    test('quadratic isClockwise', () {
      final clockwiseCurve =
          QuadraticBezier([Vector2(0.0, 0.0), Vector2(50.0, 100.0), Vector2(100.0, 0.0)]);

      expect(clockwiseCurve.isClockwise, isTrue);

      final counterclockwiseCurve =
          QuadraticBezier([Vector2(0.0, 0.0), Vector2(50.0, -100.0), Vector2(100.0, 0.0)]);

      expect(counterclockwiseCurve.isClockwise, isFalse);

      final linearCurve =
          QuadraticBezier([Vector2(0.0, 0.0), Vector2(20.0, 20.0), Vector2(100.0, 100.0)]);
    ...
    test('cubic isClockwise', () {
      final clockwiseCurve = CubicBezier(
          [Vector2(0.0, 0.0), Vector2(100.0, 250.0), Vector2(-50.0, 20.0), Vector2(100.0, 0.0)]);
      ...
      final linearCurve = CubicBezier(
          [Vector2(0.0, 0.0), Vector2(33.0, 33.0), Vector2(66.0, 66.0), Vector2(100.0, 100.0)]);
    ...
    test('quadratic isClockwise, counter-clockwise curve', () {
      final points = [Vector2(55.0, 25.0), Vector2(40.0, 40.0), Vector2(30.0, 10.0)];
      final curve = QuadraticBezier(points);
      expect(curve.isClockwise, isFalse);
    });
    ...
    test('quadratic isClockwise, diagonal degenerate curve with control point beyond end point',
        () {
      final curve =
          QuadraticBezier([Vector2(0.0, 0.0), Vector2(100.0, 100.0), Vector2(20.0, 20.0)]);
      expect(curve.isClockwise, isFalse);
    });
    ...
    test('quadratic isClockwise, horizontal degenerate curve with control point beyond end point',
        () {
      final curve = QuadraticBezier([Vector2(0.0, 0.0), Vector2(100.0, 0.0), Vector2(20.0, 0.0)]);
      expect(curve.isClockwise, isFalse);
    });
  ...
  group('isLinear', () {
    test('quadratic isLinear', () {
      ...
      final nonlinearCurve =
          QuadraticBezier([Vector2(0.0, 0.0), Vector2(20.0, 20.0), Vector2(-50.0, 100.0)]);
    ...
    test('cubic isLinear', () {
      ...
      final nonLinearCurve = CubicBezier(
          [Vector2(0.0, 0.0), Vector2(-40.0, 100.0), Vector2(66.0, -50.0), Vector2(100.0, 100.0)]);
    ...
    test('quadratic isLinear, linear curve', () {
      final points = [Vector2(-10.0, -10.0), Vector2(20.0, 20.0), Vector2(90.0, 90.0)];
      final curve = QuadraticBezier(points);
      expect(curve.isLinear, isTrue);
    });
    ...
    test('quadratic isLinear, not linear curve', () {
      final points = [Vector2(10.0, 10.0), Vector2(20.0, 20.0), Vector2(50.001, 50.0)];
      final curve = QuadraticBezier(points);
      expect(curve.isLinear, isFalse);
    });
    ...
    test('cubic isLinear, diagonal degenerate curve', () {
      final curve = CubicBezier(
          [Vector2(0.0, 0.0), Vector2(-100.0, -30.0), Vector2(100.0, 30.0), Vector2(10.0, 3.0)]);
      expect(curve.isLinear, isTrue);
    });

    test('cubic isLinear, horizontal degenerate curve', () {
      final curve = CubicBezier(
          [Vector2(0.0, 0.0), Vector2(-100.0, 0.0), Vector2(100.0, 0.0), Vector2(10.0, 0.0)]);
      expect(curve.isLinear, isTrue);
    });
  });
  ...
  group('length', () {
    ...
    test('quadratic length, linear curve', () {
      final points = [Vector2(-70.0, -70.0), Vector2(-80.0, -80.0), Vector2(-100.0, -100.0)];
      final curve = QuadraticBezier(points);
    ...
    test('cubic length, degenerate curve', () {
      final curve = CubicBezier(
          [Vector2(0.0, 0.0), Vector2(-100.0, 0.0), Vector2(100.0, 0.0), Vector2(50.0, 0.0)]);
  ...
  group('isSimple', () {
    ...
    test('quadratic isSimple, simple curve', () {
      final points = [Vector2(20.0, 20.0), Vector2(60.0, 60.0), Vector2(100.0, 100.0)];
      final curve = QuadraticBezier(points);
    ...
    test('quadratic isSimple, non-simple curve', () {
      final points = [Vector2(20.0, 60.0), Vector2(100.0, 20.0), Vector2(0.0, 100.0)];
      final curve = QuadraticBezier(points);
    ...
    test('cubic isSimple, non-simple curve with near-parallel endpoint normal vectors', () {
      final curve = CubicBezier(
          [Vector2(0.0, 0.0), Vector2(50.0, 100.0), Vector2(50.0, -99.0), Vector2(100.0, 0.0)]);

      expect(curve.isSimple, isFalse);
    });

    test('quadratic isSimple, simple curve border case', () {
      final curve = QuadraticBezier([Vector2(0.0, 0.0), Vector2(50.0, 28.86), Vector2(100.0, 0.0)]);

      expect(curve.isSimple, isTrue);
    });

    test('quadratic isSimple, non-simple curve border case', () {
      final curve = QuadraticBezier([Vector2(0.0, 0.0), Vector2(50.0, 28.87), Vector2(100.0, 0.0)]);
    ...
    test('cubic isSimple, simple curve with points close together', () {
      final curve = CubicBezier(
          [Vector2(0.0, 0.0), Vector2(0.5, 0.2), Vector2(0.995, 0.398), Vector2(1.4851, 0.594)]);

      expect(curve.isSimple, isTrue);
    });

    test('quadratic isSimple, diagonal degenerate curve', () {
      final curve = QuadraticBezier([Vector2(0.0, 0.0), Vector2(100.0, 30.0), Vector2(50.0, 15.0)]);
      expect(curve.isSimple, isFalse);
    });
    ...
    test('cubic isSimple, diagonal degenerate curve, both control points on outside', () {
      final curve = CubicBezier(
          [Vector2(0.0, 0.0), Vector2(-100.0, -30.0), Vector2(100.0, 30.0), Vector2(50.0, 15.0)]);
      expect(curve.isSimple, isTrue);
    });

    test('cubic isSimple, horizontal degenerate curve, both control points on outside', () {
      final curve = CubicBezier(
          [Vector2(0.0, 0.0), Vector2(-2000.0, 0.0), Vector2(2500.0, 0.0), Vector2(50.0, 0.0)]);
      expect(curve.isSimple, isTrue);
    });
    ...
    test('cubic isSimple, horizontal degenerate curve, one control point on outside', () {
      final curve = CubicBezier(
          [Vector2(0.0, 0.0), Vector2(-2000.0, 0.0), Vector2(25.0, 0.0), Vector2(50.0, 0.0)]);
      expect(curve.isSimple, isFalse);
    });
    ...
    test('quadratic isSimple, degenerate curve with control point overlapping end point', () {
      final curve = QuadraticBezier([Vector2(0.0, 0.0), Vector2(100.0, 0.0), Vector2(100.0, 0.0)]);
      expect(curve.isSimple, isTrue);
    });
    ...
    test(
        ...
        () {
      final curve = CubicBezier(
          [Vector2(0.0, 0.0), Vector2(0.0, 0.0), Vector2(25.0, 0.0), Vector2(100.0, 0.0)]);
      expect(curve.isSimple, isTrue);
    });
    ...
    test(
        ...
        () {
      final curve = CubicBezier(
          [Vector2(0.0, 0.0), Vector2(0.0, 0.0), Vector2(50.0, 5.0), Vector2(100.0, 0.0)]);
      expect(curve.isSimple, isTrue);
    });
    ...
    test(
        ...
        () {
      final curve = CubicBezier(
          [Vector2(0.0, 0.0), Vector2(0.0, 0.0), Vector2(2500.0, 10.0), Vector2(100.0, 0.0)]);
      expect(curve.isSimple, isFalse);
    });
    ...
    test('cubic isSimple, degenerate curve with both control points overlapping adjacent end point',
        () {
      final curve = CubicBezier(
          [Vector2(0.0, 0.0), Vector2(0.0, 0.0), Vector2(100.0, 0.0), Vector2(100.0, 0.0)]);
      expect(curve.isSimple, isTrue);
    });
  });
}
